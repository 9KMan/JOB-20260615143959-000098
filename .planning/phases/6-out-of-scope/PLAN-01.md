---
title: "Phase 06: Out of Scope"
objective: "Explicitly define boundaries by listing what's NOT being built, preventing scope creep and aligning expectations with the client's focus on fixing stability/throughput issues in their existing scraper fleet."
done_when:
  - All out-of-scope items are enumerated with clear rationale
  - Client has acknowledged and approved scope boundaries
  - No out-of-scope work is present in deliverables
---
## Objective

Define explicit boundaries for this engagement. The client needs stability and throughput fixes for their existing scraper fleet—not a ground-up rebuild. This phase documents what will NOT be built to prevent scope creep and maintain focus on closing the long tail of failures.
...
- All out-of-scope items are documented above with clear rationale
- No deliverables in subsequent phases cross into out-of-scope territory
- Client has reviewed and acknowledged scope boundaries
- Scope document is committed to repository for reference
